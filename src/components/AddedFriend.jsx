function AddedFriend({ friend }) {
    return (
        <li className="w-full sm:w-auto lg:w-full rounded flex gap-6 px-4 py-3 md:py-3 xl:py-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-800 hover:border-rose-600 dark:hover:border-gray-500 transition-all cursor-pointer">
