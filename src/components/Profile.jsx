            ...
            <div className='w-4/5 lg:w-full xl:w-max flex flex-col items-center gap-4 sm:gap-5 md:gap-12 lg:gap-16 md:flex-row md:justify-center mx-auto mt-4 md:mt-8 px-4 py-8 md:py-10 lg:px-20 text-gray-900 dark:text-gray-100 border-2 border-gray-400 hover:border-rose-500 dark:border-gray-700 dark:hover:border-gray-500 rounded transition-colors'>
                ...
                <div className='flex flex-col items-center text-center'>
                    ...
                    <div className='flex gap-3'>
                        <Link to='/account/edit' className='bg-green-500 hover:bg-green-400 dark:bg-green-500 dark:hover:bg-green-600 text-gray-50 text-lg px-3 py-1 lg:px-4 lg:py-2 rounded outline-none'>
                            Edit
                            <i className="fa-regular fa-pen-to-square ml-2"></i>
                        </Link>

                        <Link to="/account/delete" className="bg-rose-600 hover:bg-rose-500 dark:bg-rose-600 dark:hover:bg-rose-700 text-gray-50 text-lg px-3 py-1 lg:px-4 lg:py-2 rounded outline-none">
                            Delete
