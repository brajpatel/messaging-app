    ...
    return (
        <section className="bg-gray-50 dark:bg-gray-900 h-screen">
            <div className="flex items-center justify-center gap-6 px-6 mx-auto lg:py-0">
                <div className="hidden md:flex flex-col items-center md:w-2/5 lg:w-1/2">
                ...
                <div className="bg-white dark:bg-gray-800 shadow-lg px-6 pb-6 mt-8 md:mt-12 space-y-4 w-full md:w-3/5 lg:w-1/2 xl:w-1/3 md:space-y-6 rounded-lg">
                    ...
                    <form className="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            <input className='block text-lg w-full px-4 py-2 mt-2 border-2 focus:outline-none focus:border-rose-500 rounded-md' type="text" name="username" id="username" placeholder="superDuperCoolKid9000" required/>
                        </div>
                        ...
                        <div>
                            <label className="text-lg dark:text-gray-100" htmlFor="profile_picture">Profile Picture (url)</label>
                            <input className='block text-lg w-full px-4 py-2 mt-2 border-2 focus:outline-none focus:border-rose-500 rounded-md' type="text" name="profile_picture" id="profile_picture" placeholder="ଘ(੭˃ᴗ˂)੭" required/>
                        </div>
