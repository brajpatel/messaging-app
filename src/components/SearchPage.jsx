...
function SearchPage() {
    return (
        ...
        <div className='w-1/2 flex justify-center items-center py-4'>
            <input className='bg-white dark:bg-gray-700 text-lg text-black dark:text-gray-100 w-full px-4 py-2 mt-2 border-2 border-gray-200 dark:border-gray-700 focus:outline-none focus:border-rose-500 dark:focus:border-rose-500 rounded-md' placeholder="Search by username"/>
        </div>
    </div>
    )
}
