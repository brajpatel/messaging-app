    ...
    const exitPage = () => {
        setTimeout(() => {
            window.onbeforeunload = function(e) {
                document.querySelector('.search-page').classList.add('exit');
            }
        }, 0);
    }

    return (
        <div className='search-page h-screen lg:h-full w-full lg:w-auto absolute top-0 left-0 lg:relative bg-white dark:bg-gray-800 overflow-x-hidden overflow-y-auto'>
