...
function SearchPage() {
    return (
        ...
        <div className="h-[4.4rem] md:h-[4.6rem] font-bold bg-rose-600 lg:bg-white dark:bg-gray-700 lg:dark:bg-gray-800 text-gray-50 lg:text-gray-900 dark:text-gray-50 flex justify-between items-center px-4">
