...
function ProfileEdit() {
    ...
    return (
        <div className='h-screen lg:h-full w-full lg:w-auto absolute top-0 left-0 lg:relative lg:px-4 lg:py-3 flex flex-col bg-white dark:bg-gray-800 overflow-x-hidden overflow-y-auto'>
